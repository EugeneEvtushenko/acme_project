...
# Без этого куска кода на Windows скрипт восстановления пароля шлет пустые письма

# import os
# if not os.getenv('DJANGO_ALLOW_SKIP_DNS', False):
#     import socket


#     def fixed_getfqdn(*args, **kwargs):
#         return 'localhost'
